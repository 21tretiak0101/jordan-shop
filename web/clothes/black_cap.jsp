...
<main id="main">
    <div class="clothes-page">
        <h1>Jordan Pro Jumpman Classics Black Hat</h1>
        <div id="left">
            <img src="${pageContext.request.contextPath}/img/black_cap.png" alt="black_cap">
        </div>
        <div id="right">
            <p>50$</p>
            <ul>
            ...
            <form action="jordan" method="post">
                ...
                <input type="hidden" name="name" value="black_cap">
