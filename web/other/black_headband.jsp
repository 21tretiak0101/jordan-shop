...
<main id="main">
    <div class="clothes-page">
        <h1>Jordan Dri-FIT Jumpman Headband Black</h1>
        <div id="left">
            <img src="${pageContext.request.contextPath}/img/black_headband.png" alt="black_headband">
        </div>
        <div id="right">
            <p>10$</p>
            <ul>
            ...
            <form action="jordan" method="post">
                <input type="hidden" name="name" value="black_headband">
